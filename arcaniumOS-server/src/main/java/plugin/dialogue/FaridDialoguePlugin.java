...
/**
 * Handles the FaridDialoguePlugin dialogue.
 *
 * @author trees
 */
public class FaridDialoguePlugin extends DialoguePlugin {

    public FaridDialoguePlugin() {

    }

    public FaridDialoguePlugin(Player player) {
        super(player);
    }
    ...
    public DialoguePlugin newInstance(Player player) {
        ...
        return new FaridDialoguePlugin(player);
    }
