 ...
 * @version 1.0
 */
public final class AlKharidWarriorNPC extends AbstractNPC {
     ...
     */
    private AlKharidWarriorNPC(int id, Location location) {
	super(id, location);
    }

    @Override
    public AbstractNPC construct(int id, Location location, Object... objects) {
	return new AlKharidWarriorNPC(id, location);
    }
